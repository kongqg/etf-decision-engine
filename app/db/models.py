...
class MarketSnapshot(Base):
    ...
    budget_total_pct: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    budget_by_category_json: Mapped[str] = mapped_column(Text, nullable=False, default="{}")
...
class ETFFeature(Base):
    ...
    momentum_5d_rank: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    momentum_10d_rank: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    momentum_20d_rank: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    trend_rank: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    volatility_rank: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    drawdown_rank: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    liquidity_rank: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    intra_score: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    ...
    basic_filter_pass: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    basic_filter_reason: Mapped[str] = mapped_column(Text, nullable=False, default="")
...
class AdviceRecord(Base):
    ...
    display_action: Mapped[str] = mapped_column(String(20), nullable=False, default="")
    strategy_version: Mapped[str] = mapped_column(String(40), nullable=False, default="score_v2")
    ...
    target_portfolio_json: Mapped[str] = mapped_column(Text, nullable=False, default="{}")
    budget_context_json: Mapped[str] = mapped_column(Text, nullable=False, default="{}")
    candidate_summary_json: Mapped[str] = mapped_column(Text, nullable=False, default="{}")
...
class AdviceItem(Base):
    ...
    name: Mapped[str] = mapped_column(String(100), nullable=False)
    action_code: Mapped[str] = mapped_column(String(30), nullable=False, default="")
    intent: Mapped[str] = mapped_column(String(20), nullable=False, default="")
    ...
    delta_weight: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    is_new_position: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    replace_threshold_used: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    final_score: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    intra_score: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    global_rank: Mapped[int | None] = mapped_column(Integer, nullable=True)
    category_rank: Mapped[int | None] = mapped_column(Integer, nullable=True)
    hold_days: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    score_gap_vs_holding: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    replacement_symbol: Mapped[str] = mapped_column(String(10), nullable=False, default="")
...
class Trade(Base):
    ...
    advice_item_id: Mapped[int | None] = mapped_column(ForeignKey("advice_items.id"), nullable=True)
    intent: Mapped[str] = mapped_column(String(20), nullable=False, default="")
    weight_before: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    weight_after: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
